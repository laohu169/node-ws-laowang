...
const UUID = process.env.UUID || '19e2b877-dca5-4579-a4f9-aa919705d906'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const DOMAIN = process.env.DOMAIN || 'alala-z9vb5.eu-east-1.migetapp.com';       // 填写项目域名或已反代的域名，不带前缀，建议填已反代的域名
